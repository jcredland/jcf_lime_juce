 ...
 *
  ...
  This file makes it easy to use in JUCE software.   It's *great* for instantly useful
  icons.
...
/**
 * This is FontAwesomeIcons.  It provides a range of modern 2D symbols.  This file
 * includes a small old open licensed version of the FontAwesome font.  You can use this
 * to draw icons in your app.  Although if you use this seriously I recommend you get the
 * latest version of the font and buy a license, there's loads more icons in the latest
 * paid version.
 */
...
public:
     ...
     */
    static void drawIcon (juce::Graphics& g, int iconCode, const juce::Rectangle<float>& area);

    /**
     * Create a mouse cursor from a FontAwesome icon
     */
    static juce::MouseCursor getMouseCursor (int iconCode, int size, juce::Point<int> hotspot);

    static void drawIconRotated (juce::Graphics& g, int iconCode, const juce::Rectangle<float>& area, float radians);
    ...
    {
    public:
        IconComponent (int iconCode, const juce::Colour& colour);
    ...
    static std::unique_ptr<juce::DrawableText> createDrawable (int iconCode, float height = 20.0f, juce::Colour fgColour = juce::Colours::lightgrey);
